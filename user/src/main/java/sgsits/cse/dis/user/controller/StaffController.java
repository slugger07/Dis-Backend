...
public class StaffController {
	...
	public ResponseEntity<ResponseMessage> addNewStaff(@RequestBody AddNewUser addNewUser,HttpServletRequest request) throws ConflictException {
		return new ResponseEntity<>(new ResponseMessage(staffServiceImpl.addNewMember(addNewUser, jwtResolver.getIdFromJwtToken(request.getHeader("Authorization")))), HttpStatus.OK);
	}
	...
	public ResponseEntity<ResponseMessage> getMyUserId(HttpServletRequest request) throws NotFoundException{
		return new ResponseEntity<>(new ResponseMessage(jwtResolver.getIdFromJwtToken(request.getHeader("Authorization"))), HttpStatus.OK);
	}
