...
public class GuideAllotmentController {
	...
	@ApiOperation(value = "All Batches", response = BatchData.class, httpMethod = "GET", produces = "application/json")
	@GetMapping(value = RestAPI.GET_ALL_BATCHES, produces = "application/json")
	public ResponseEntity<List<BatchData>> getStaffData(@PathVariable("session") String session,@PathVariable("ugOrPg") String ugOrPg) {
